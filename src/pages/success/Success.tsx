    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          <div className="">
            {" "}
            <div className="flex justify-center items-center md:mt-[8rem] sm:mt-[6rem] mt-[3rem] h-fit w-fit mx-auto bg-[#dcdcdc] p-[2rem] sm:p-[4rem] ">
              <div className="success flex flex-col gap-4">
                <p className="icon text-green-600 text-[3rem] flex justify-center items-center">
                  <BsBagCheckFill />
                </p>
                <h2 className="text-4xl m-0 max-[900px]:text-4xl max-[900px]:text-center max-[110px]:text-2xl text-center font-OpenSans font-bold max-[640px]:text-3xl">
                  Thank you for your order!
                </h2>
                <p className="email-msg text-sm  max-[640px]:mt-2 text-center   leading-normal max-[900px]:text-center  min-[110px]:leading-6 font-normal font-OpenSans  ">
                  Check your email inbox for the receipt.
                </p>
                <p className="description text-center">
                  If you have any questions, please email {""}
                  <a
                    className="email text-orange-600"
                    href="mailto:owoadehabeeb04@mail.com"
                  >
                    owoadehabeeb04@mail.com{" "}
                  </a>
                </p>
                <Link to="/Shop                                                                                                                                                                               ">
                  <button className=" rounded-3xl w-[80%] mx-auto bg-black text-white flex justify-center items-center py-4 px-10 font-OpenSans font-medium leading-normal max-[1024px]:py-4 max-[1024px]:px-4 max-[480px]:w-11/12 max-[480px]:mt-[0rem]">
