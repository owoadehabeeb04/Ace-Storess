...
import Acecart from "../../components/cart/acecart";
import CartCheckPay from "../../components/cart/cartCheckoutPayment";
import CTA from "../../components/footer/CTA";
import { useStateContext } from "../../context/stateContext";
import { Link } from "react-router-dom";
import empty from "../../../src/img/empty-cart-svgrepo-com.svg";
...
const Cart = () => {
  ...
  const {  setboldCartCheckPay, setCart }: any =
    useStateContext();
  useEffect(() => {
      ...
      {loading ? (
        ...
        <div>
          ...
          {cart.length > 0 ? (
            ...
            <div className="flex justify-center gap-[0.6rem] sm:gap-4  items-center flex-col mt-6 sm:h-fit h-[60vh]  ">
              <div className="w-2/4 flex justify-center items-center">
                <img className="w-2/4" src={empty} alt="empty cart" />
              </div>
              <h1 className="text-4xl m-0 max-[900px]:text-4xl text-center  max-[110px]:text-2xl font-OpenSans font-bold max-[640px]:text-[1.2rem]">
